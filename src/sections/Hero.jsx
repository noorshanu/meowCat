    ...
    <section className=" pt-4  pb-[1rem]">
      <div className="container-wrapper flex justify-center flex-col ">
        ...
        <div className=" flex justify-center gap-5 items-center">
          <a
            href="https://twitter.com/MEOWCATSolana"
          ...
          <a
            href="https://www.dextools.io/app/en/solana/pair-explorer/9U8yBLHEsFcqJLQiyrvi8tHYJ4haAs8sAnYrdxvxFfk1?t=1711488328507"
            target="_blank"
